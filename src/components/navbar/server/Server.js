...
const Server = () => {
    ...
    return (
        <div className="server-btn-container">
            ...
            <ButtonLink to={to} label={content} activeOnlyWhenExact={true} className="nav-btn"
